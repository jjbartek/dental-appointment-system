...
import com.das.users.UserService;
...
class UserServiceTest {
    ...
    void testGetUsers_shouldReturnResponse() {
        ...
        Page<User> page = new PageImpl<>(List.of(
                new User("User 1", "user1@gmail.com", "password", List.of(UserRole.EMPLOYEE)),
                new User("User 2", "user2@gmail.com", "password", List.of(UserRole.EMPLOYEE))));
        List<UserDTO> userDTOS = List.of(
                new UserDTO(1, "User 1", "user1@gmail.com", List.of(UserRole.EMPLOYEE)),
                new UserDTO(2, "User 2", "user2@gmail.com", List.of(UserRole.EMPLOYEE)));
    ...
    void testAddUser_shouldAddUser() {
        ...
        User mappedUser = new User("User 1", email, hashedPassword, List.of(UserRole.EMPLOYEE));
        User createdUser = new User(1, "User 1", email, hashedPassword, List.of(UserRole.EMPLOYEE));
        UserDTO userDTO = new UserDTO(1, "User 1", email, List.of(UserRole.EMPLOYEE));
    ...
    void testUpdateUser_shouldThrowEmailNotAvailable() {
        ...
        User existingUser =
                new User(5, "User 1", "u1@gmail.com", "hashedPassword", List.of(UserRole.EMPLOYEE));
        UserUpdateRequest userUpdateRequest =
    ...
    void testUpdateUser_shouldUpdateUserWithEmailAndPasswordUnchanged() {
        ...
        User expectedUser =
                new User(5, "Different name", "u1@gmail.com", "hashedPassword", List.of(UserRole.ADMIN));
        UserDTO expectedUserDTO = new UserDTO(1, "Different name", "u1@gmail.com", List.of(UserRole.ADMIN));
    ...
    void testUpdateUser_shouldUpdateUserWithEmailAndPasswordChanged() {
        ...
        ArgumentCaptor<User> capturedUser = ArgumentCaptor.forClass(User.class);
        User expectedUser =
                new User(5, "Different name", newEmail, encodedNewPassword, List.of(UserRole.ADMIN));
        UserDTO expectedUserDTO = new UserDTO(1, "Different name", newEmail, List.of(UserRole.ADMIN));
    ...
    void testGetUserById_shouldReturnUserDTO() {
        ...
        //when
        UserDTO expectedUserDTO = new UserDTO(1, "User 1", "u1@gmail.com", List.of(UserRole.EMPLOYEE));
        when(userRepository.findById(eq(id))).thenReturn(Optional.of(existingUser));
    ...
    void testGetUsersByNameOrEmail_shouldReturnCollectionResponse() {
        ...
        Page<User> page = new PageImpl<>(List.of(
                new User("user 1", "anemail@gmail.com", "password", List.of(UserRole.EMPLOYEE)),
                new User("user 2", "user2@gmail.com", "password", List.of(UserRole.EMPLOYEE))));
        List<UserDTO> userDTOS = List.of(
                new UserDTO(1, "user 1", "anemail@gmail.com", List.of(UserRole.EMPLOYEE)),
                new UserDTO(2, "user 2", "user2@gmail.com", List.of(UserRole.EMPLOYEE)));
